...
<div class="input">
    <div class="input-prefix"
        ><span class="valign-sibling"></span
        ><i class="icon fa">&#xf002;</i
    ></div>
...
<form class="form-inline">
    ...
    <div class="form-group">
        ...
        <div style="width:200px" class="input">
            <div class="input-prefix">
                <span class="valign-middle">￥</span>
                <span class="valign-sibling"></span>
            </div>
            <div class="input-suffix">
                <span class="valign-sibling"></span>
                <span class="valign-middle">元</span>
        ...
        <div style="width:300px;" class="input-group">
            ...
            <div class="input-group-body">
                <div class="input">
                    <div class="input-prefix"
                        ><span class="valign-sibling"></span
                        ><span class="valign-middle">www.</span
                    ></div>
                    <div class="input-suffix"
                        ><span class="valign-sibling"></span
                        ><span class="valign-middle">.com</span
                    ></div>
                    <div class="input-suffix"
                        ><span class="valign-sibling"></span
                        ><span class="input-counter">0/20</span
